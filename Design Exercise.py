...
col2 = sg.Column([[sg.Image(r'C:\Users\fire_\Desktop\Studies (University)\T8\40.317 Financial Systems Design\Design Exercise\rsz_sutd_logo.png')],
                  [sg.T()],
...
win = sg.Window('Trading Game Team Console', layout, icon='SUTDLogo.ico')
